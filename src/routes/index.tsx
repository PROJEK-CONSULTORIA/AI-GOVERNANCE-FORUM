...
const schedule = [
  ...
  { time: "15h30", title: "Painel 8 — IA começa pelos Dados: qualidade, governança e inovação.", desc: "Judiciário, Ministério Público, Executivo, transparência algorítmica e melhoria dos serviços públicos." },
