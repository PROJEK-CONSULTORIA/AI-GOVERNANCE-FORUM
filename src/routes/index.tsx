...
const schedule = [
  ...
  { time: "16h00", title: "Painel 9 — A IA e o Futuro do Trabalho: pessoas, comunidades e culturas.", desc: "Regulamentação, soberania digital, liderança, competências do futuro e o papel dos conselhos." },
