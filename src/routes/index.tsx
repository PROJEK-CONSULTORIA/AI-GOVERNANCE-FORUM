...
const schedule = [
  ...
  { time: "14h30", title: "Painel 6 — IA no Digital e Entretenimento: criatividade, inovação e governança.", desc: "IA generativa, direitos autorais, conteúdo sintético, criatividade assistida e propriedade intelectual." },
