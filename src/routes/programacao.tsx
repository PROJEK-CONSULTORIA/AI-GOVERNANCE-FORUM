...
const agenda: Session[] = [
  ...
  { time: "15h00", type: "painel", title: "Painel 7 — Inovação, Startups e o Futuro da IA", desc: "Como a Inteligência Artificial está redefinindo a inovação, impulsionando startups e criando novos modelos de negócio, com a governança como base para um crescimento sustentável, competitivo e responsável. (Alexandre Darzé - LH Investimentos.)", speakers: [{ name: "Alexandre Darzé", role: "Managing Partner · LH Invest & Lucen Capital" }, { name: "Rodrigo Paolilo", role: "CEO · Grupo Rede Mais" }], track: "etica" },
