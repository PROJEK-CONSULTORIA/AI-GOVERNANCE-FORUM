...
const agenda: Session[] = [
  ...
  { time: "14h00", type: "painel", title: "Painel 5 — IA no Digital e Entretenimento: criatividade, inovação e governança", desc: "Como a Inteligência Artificial está redefinindo a criação de conteúdo, a experiência do público e os modelos de negócio, exigindo uma governança que equilibre inovação, ética, proteção da propriedade intelectual e confiança no ecossistema digital.", speakers: [{ name: "Nélio Castro", role: "Esp. em IA · Rede Bahia" }], track: "etica" },
